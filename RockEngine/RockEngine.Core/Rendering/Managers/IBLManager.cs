...
namespace RockEngine.Core.Rendering.Managers
{
     public class IBLManager
    {
        ...
        private readonly VulkanSynchronizationContext _vulkanSynchronizationContext;
            ...
            )
        {
            ...
            //_vulkanSynchronizationContext = vulkanSynchronizationContext;
        }
        ...
        public async Task<Texture> GenerateIrradianceMap(Texture envMap, uint size = 128)
        {
            ...
            //await _vulkanSynchronizationContext.ExecuteAsync(async () =>
            {
